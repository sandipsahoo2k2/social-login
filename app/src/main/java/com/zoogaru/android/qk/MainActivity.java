    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileTracker = new ProfileTracker() {
            ...
            protected void onCurrentProfileChanged(
                ...
                // App code
                String oldText = info.getText().toString();
                info.setText(oldText + " Hello profile info available ");
            }
        };
        ...
        else
        {
            ...
            if(profile != null) {
                info.setText("Picture URI " + profile.getProfilePictureUri(50, 50));

            }
            else
            {
                info.setText("Hello prifle is null");
            }
        }
        //printKeyHash();
